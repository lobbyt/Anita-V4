...
global.anitav4 = process.env.BOT_NAME || "King lobby-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "Lobby";
global.packname = process.env.PACK_NAME || "𝐕𝟒";
global.author = process.env.AUTHOR || "Gracious";
